...
namespace uter.tuwienscrm.authservice.Controllers
{
    public class TwitterController : Controller
    {
        ...
        private string TWITTER_CONSUMER_KEY { get; set; }
        private string TWITTER_CONSUMER_SECRET_KEY { get; set; }
        ...
        public ActionResult Logon(string oauth_token, string oauth_verifier, string ReturnUrl)
        {
            ...
            if (string.IsNullOrEmpty(oauth_token) || string.IsNullOrEmpty(oauth_verifier))
            {
                ...
                var redirecturl = OAuthUtility.BuildAuthorizationUri(token.Token, true).ToString();
        ...
        private static EntityCollection FindTwitterConfig(OAuthTokenResponse tokens, IOrganizationService service)
        {
            ...
            query.Attributes.Add("cott_twitteruserid");
